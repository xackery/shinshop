	...
	<div class="row" style="margin-top:60px;">
		<div class="row">
	  	...
	  	<div class="col-md-8 col-md-offset-2">
	  		<div class="row">
				<form class="well bs-component" action="/item/search" method="GET">
						...
						<ul class="list-group">
							{foreach $items item=item}
				  			<li class="list-group-item">
				  				...
				  				{$item->Name}
				  				<br>
				  				{*<a href="/item/editor/{$item->id}" class="btn btn-primary btn-xs"> <i class="glyphicon glyphicon-edit"></i> Editor</a> *}
				  				{*<a href="/player/inventory/{$item->id}" class="btn btn-primary btn-xs"> <i class="glyphicon glyphicon-th"></i> NPC Inventory</a>*}
				  				<a href="/item/player/{$item->id}" class="btn btn-primary btn-xs"> <i class="glyphicon glyphicon-user"></i> Player Inventory</a> 
				  				</div>
				  			</li>
							{/foreach}
						</ul>
