			...
			<div class="main-block">
				...
				<div class="page-heading-two">
					<div class="container">
						...
						<div class="breads">
							<a href="/">Home</a> / <a href="/minecraft">Minecraft</a> / <a href="/minecraft/mod">Mod</a> / {$mod->full_name}
						</div>
...
{*
							...
							<div class="col-md-4 col-sm-6">
								<div class="row">
									<a href="{$mod->website}" target="_blank"><img class="img-responsive img-center center-block" src="/images/minecraft/mod/{$mod->image}" alt="{$mod->name}"/><br>
								</div>
								<div class="row">
							...
							<a href="/minecraft/mod/{$mod->name}/item/"><button class="btn btn-lblue">Item List</button></a>
							</div>
						</div>
