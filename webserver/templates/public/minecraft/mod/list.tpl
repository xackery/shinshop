		...
		<div class="outer">
			...
			<div class="main-block">
				...
				<div class="page-heading-two">
					<div class="container">
						<h2>Minecraft Mods <span>Modifications to minecraft.</span></h2>
						<div class="breads">
							<a href="/">Home</a> / <a href="/minecraft">Minecraft</a> / Mod
						</div>
				                ...
				                {foreach $mods as $mod}
									...
									<div class="blog-one-item">
										...
										<div class="blog-one-img">
											<!-- Image -->
											<a href="/minecraft/mod/{$mod->name}/about"><img src="/images/minecraft/mod/{$mod->image}" alt="{$mod->full_name}" class="img-responsive img-thumbnail" /></a>
										</div>
										<!-- blog One Content -->
										<div class="blog-one-content">
											<!-- Heading -->
											<h3><a href="/minecraft/mod/{$mod->name}/about">{$mod->full_name|truncate:256}</a></h3>
											<!-- Blog meta -->
											<div class="blog-meta">
												<a href="/minecraft/mod/{$mod->name}/about">About</a> | <a href="/minecraft/mod/{$mod->name}/item">Items</a> | <a target="_blank" href="{$mod->website}">Website</a>
														...
														<ul>
															...
															<li>
																<a href="/minecraft/mod/{$mod->name}/about">
																	<!-- Item image -->
																	<img src="/images/minecraft/mod/{$mod->image}" alt="{$mod->full_name} Image" class="img-responsive img-thumbnail" />
																	<!-- Item title -->
