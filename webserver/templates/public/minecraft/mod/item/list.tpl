		...
		<div class="outer">
			...
			<div class="main-block">
				...
				<div class="page-heading-two">
					<div class="container">
						<h2>Items of Interest for {$mod->full_name} <span>Or at least, items I have reviewed so far.</span></h2>
						<div class="breads">
							<a href="/">Home</a> / <a href="/minecraft">Minecraft</a> / <a href="/minecraft/mod">Mods</a> / <a href="/minecraft/mod/{$mod->name}/about">{$mod->full_name}</a> / Item
						</div>
