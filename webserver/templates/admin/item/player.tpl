		...
		<div class="row">
	      <div class="col-md-12">
	        <ul class="breadcrumb">
	          ...
	          <li><a href="/admin/item/player/">Player</a></li>
	  	...
	  	<div class="col-md-8 col-md-offset-2">
			...
			<div class="row">
			    <div class="panel panel-default">
					...
					{else}
					There {if $total == 1}is 1 player that have this item.{else}are {$total} players that have this item. Showing {$start} to {$end}{/if} 
					</div>
						<div class="panel-body">
						<ul class="list-group">
